...
// ---------------------------------------------------------------------------
// validateImportText — standalone validator (extracted from importFromText)
// so callers can validate BEFORE taking a pre-import snapshot. Throws
// ImportError on any failure, returns parsed SyncBundle on success.
// ---------------------------------------------------------------------------
